...
export async function createNodeWorkerEnv(): Promise<any> {
	...
	const env: any = {
		...
		IMAGE_PROMPT_HMAC_SERVICE_ID: process.env.IMAGE_PROMPT_HMAC_SERVICE_ID,
		IMAGE_PROMPT_HMAC_SECRET: process.env.IMAGE_PROMPT_HMAC_SECRET,
		IMAGE_PROMPT_REDIS_URL: process.env.IMAGE_PROMPT_REDIS_URL,
		IMAGE_PROMPT_AGENTS_BASE_URL: process.env.IMAGE_PROMPT_AGENTS_BASE_URL,
		IMAGE_PROMPT_AGENTS_TOKEN: process.env.IMAGE_PROMPT_AGENTS_TOKEN,
		IMAGE_PROMPT_AGENTS_TIMEOUT_MS: process.env.IMAGE_PROMPT_AGENTS_TIMEOUT_MS,
		IMAGE_PROMPT_HMAIGC_RELAY_URL: process.env.IMAGE_PROMPT_HMAIGC_RELAY_URL,
		IMAGE_PROMPT_HMAIGC_RELAY_SERVICE_ID:
			process.env.IMAGE_PROMPT_HMAIGC_RELAY_SERVICE_ID,
		IMAGE_PROMPT_HMAIGC_RELAY_HMAC_SECRET:
			process.env.IMAGE_PROMPT_HMAIGC_RELAY_HMAC_SECRET,
