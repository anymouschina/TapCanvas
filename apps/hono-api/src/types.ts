...
export type WorkerEnv = Record<string, unknown> & {
	...
	IMAGE_PROMPT_HMAC_SERVICE_ID?: string;
	IMAGE_PROMPT_HMAC_SECRET?: string;
	IMAGE_PROMPT_REDIS_URL?: string;
	IMAGE_PROMPT_AGENTS_BASE_URL?: string;
	IMAGE_PROMPT_AGENTS_TOKEN?: string;
	IMAGE_PROMPT_AGENTS_TIMEOUT_MS?: string;
	IMAGE_PROMPT_HMAIGC_RELAY_URL?: string;
	IMAGE_PROMPT_HMAIGC_RELAY_SERVICE_ID?: string;
	IMAGE_PROMPT_HMAIGC_RELAY_HMAC_SECRET?: string;
